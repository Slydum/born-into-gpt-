...
export const ACTIVITY_LABELS = {
  ...
  eating: 'Eating',
  cooking: 'Cooking a family meal',
  familyMeal: 'Sharing a family meal',
  washDishes: 'Washing dishes',
  laundry: 'Doing laundry',
  takeTrash: 'Taking out the trash',
  cleanBathroom: 'Cleaning the bathroom',
